...
Encryption Scheme in Cloud Computing </span><small></small></h1>
    ...
    <div class="content">
      <div class="content_bg">
        <div class="menu_nav">
         <ul>
            <li><a href="ViewRPersonalProfile.jsp">View Personal Profile</a></li>
            <li><a href="ViewRMedicalProfile.jsp">View Medical Profile</a></li>
   ...
   <h2><b>View User Profile Screen</b></h2>
	...
	ResultSet rs = stmt.executeQuery("select medical_structure,pprivate_key,ppublic_key from access_structure where username='"+patient+"'");
	while(rs.next()){
		...
		if(att.indexOf(usertype) != -1){
			...
			<tr><th>Patient Name</th><th>FileName</th>
			<th>Upload Date</th><th>Download History</th>
			<%
			Statement stmt1 = con.createStatement();
	ResultSet rs1 = stmt1.executeQuery("select username,file_name,upload_date from history where username='"+patient+"'");
	while(rs1.next()){
		%>
	...
	<td><a href="DownloadHistory.jsp?t1=<%=rs1.getString(1)%>&t2=<%=rs1.getString(2)%>"><font size="3" color="black">Download</a></td>
	
	</td>
<%}}}else{
		out.println("<font size=3 color=black>No access found</font>");
	}
	}%>
	</tr>
	</table>
