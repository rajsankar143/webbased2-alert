...
public class Chart extends ApplicationFrame{
	static int cp,fh;
	static String title;
public Chart(String paramString,int c,int f){
	super(paramString);
	cp = c;
	fh = f;
...
private static CategoryDataset createDataset(){
	...
	localDefaultCategoryDataset.addValue(cp,"CP-ABE","CP-ABE");
	localDefaultCategoryDataset.addValue(fh,"FH-CPABE","FH-CPABE");
...
private static JFreeChart createChart(CategoryDataset paramCategoryDataset){
	JFreeChart localJFreeChart = ChartFactory.createBarChart(title,"Technique Name", "Storage Cost", paramCategoryDataset, PlotOrientation.VERTICAL, true, true, false);
