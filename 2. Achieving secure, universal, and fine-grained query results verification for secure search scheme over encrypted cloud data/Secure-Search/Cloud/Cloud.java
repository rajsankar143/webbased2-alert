...
public Cloud(){
	...
	l1 = new JLabel("<html><body><center>Achieving secure, universal, and fine-grained query results<br/>verification for secure search scheme over<br/>encrypted cloud data".toUpperCase());
	l1.setFont(this.f1);
