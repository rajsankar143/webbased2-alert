...
public class Chart extends ApplicationFrame{
	...
	static long time;
	static int size;
public Chart(String paramString,long t,int s){
	super(paramString);
	time = t;
	size = s;
...
private static CategoryDataset createDataset(){
	...
	localDefaultCategoryDataset.addValue(size,"Keyword Size","Keyword Size");
	localDefaultCategoryDataset.addValue(time,"Verification Time","Verification Time");
...
private static JFreeChart createChart(CategoryDataset paramCategoryDataset){
	JFreeChart localJFreeChart = ChartFactory.createBarChart(title,"Keywords Vs Time", "Keyword Size & Veification Time", paramCategoryDataset, PlotOrientation.VERTICAL, true, true, false);
